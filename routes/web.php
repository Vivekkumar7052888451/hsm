...
//        Route::get('export-ambulances', 'AmbulanceController@ambulanceExport')->name('ambulance.excel');
    ...
    Route::middleware('role:Admin|Doctor|Receptionist')->group(function () {
        ...
        Route::get('er',[EmergencyRoomController::class, 'index'])->name('er.patient.index')->middleware('modules');
        Route::get('er/create',[EmergencyRoomController::class, 'create'])->name('er.patient.create');
        Route::post('er/store',[EmergencyRoomController::class, 'store'])->name('er.patient.store');
        Route::delete('er/{erRoom}',
                [EmergencyRoomController::class, 'destroy'])->name('er.patient.destroy');
       Route::get('er/{erRoom}/edit',
                [EmergencyRoomController::class, 'edit'])->name('er.patient.edit');
        Route::patch('ipds/{erRoom}',
                [EmergencyRoomController::class, 'update'])->name('er.patient.update');
        // Route::get('er-cases-list',[EmergencyRoomController::class, 'getPatientCasesList'])->name('er.cases.list');
        // IPD Patient routes
        Route::get('ers',
