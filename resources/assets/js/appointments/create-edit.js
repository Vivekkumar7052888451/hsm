    ...
    if($('#appointmentForm').length || $('#editAppointmentForm').length){
        ...
        listenSubmit('#editAppointmentForm', function (event) {
            ...
            if (isEmpty(editAppointmentOpdDate)) {
                $('#editAppointmentErrorsBox').show().removeClass('d-none').html('Please select appointment date.').delay(5000).slideUp(300)
                return false
            }
            if (appointmentEditTimeSlot == null || appointmentEditTimeSlot ==
                '') {
                $('#editAppointmentErrorsBox').show().html('Please select appointment time slot.').delay(5000).slideUp(300)
                return false
            }
...
listenSubmit('#appointmentForm', function (event) {
    ...
    if (isEmpty(appointmentOpdDate)) {
        $('#createAppointmentErrorsBox').show().removeClass('d-none').html('Please select appointment date.').delay(5000).slideUp(300)
        return false
    }
    if (appointmentSelectedTime == null || appointmentSelectedTime ==
        '') {
        $('#createAppointmentErrorsBox').show().removeClass('d-none').html('Please select appointment time slot.').delay(5000).slideUp(300)
        return false
    }
    event.preventDefault()
    screenLock()
