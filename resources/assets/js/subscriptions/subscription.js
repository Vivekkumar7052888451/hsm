...
listenChange('#paymentType', function () {
    ...
    if (paymentType == 1) {
        $('.proceed-to-payment, .razorPayPayment, .cashPayment, .paytmPayment, .paystackPayment').addClass('d-none')
    ...
    if (paymentType == 3) {
        $('.proceed-to-payment, .paypalPayment, .cashPayment, .paytmPayment, .paystackPayment').addClass('d-none')
    ...
    if (paymentType == 5) {
        $('.proceed-to-payment, .paypalPayment, .razorPayPayment, .cashPayment, .paystackPayment').addClass('d-none')
        $('.paytmPayment').removeClass('d-none')
        $('.paymentByPaytm').attr('disabled', false)
    }
    if (paymentType == 6) {
        $('.proceed-to-payment, .paypalPayment, .razorPayPayment, .cashPayment, .paytmPayment').addClass('d-none')
