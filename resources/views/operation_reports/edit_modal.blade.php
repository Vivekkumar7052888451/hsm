                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            ...
                            {{ Form::select('case_id', $cases, null, ['class' => 'form-select','required','id' => 'editOperationCaseId','placeholder'=>'Select Case']) }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            ...
                            <span class="required"></span>
                            {{ Form::text('date', null, ['class' => 'form-control bg-white','required','id' => 'editOperationDate','autocomplete' => 'off']) }}
                        </div>
                    </div>
                    <div class="col-md-12">
