<div class="row mb-5 pt-5">
    ...
    <div class="col-md-4">
        <div class="mb-5">
            ...
            {{ Form::select('hospital_type_id', $hospitalType, $hospital->hospital_type_id ? $hospital->hospital_type_id : null, ['class' => 'form-select', 'id' => 'hospitalTypeId', 'placeholder' => 'Hospital Type', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-md-4">
        <div class="mb-5">
