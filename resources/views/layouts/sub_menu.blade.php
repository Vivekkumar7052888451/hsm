...
@endmodule
@module('ER',$modules)
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('er*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('er*') ? 'active' : '' }}"
       href="{{ url('er') }}">{{ __('messages.er_ro') }}</a>
</li>
@endmodule
@endrole
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*','prescriptions*, prescription-medicine-show*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/general-settings*','super-admin/footer-settings*','super-admin/super-admin-currency-settings*')) ? 'd-none' : '' }}">
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/general-settings*','super-admin/super-admin-currency-settings*','super-admin/footer-settings*')) ? 'd-none' : '' }}">
