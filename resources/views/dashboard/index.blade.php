                                ...
                                <a class="text-decoration-none" href="{{ route('invoices.index') }}">
                                    <div class="bg-primary shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                        ...
                                        <div class="text-end text-white">
                                            <h2 class="fs-1-xxl fw-bolder text-white">{{$currencySymbol}} {{ formatCurrency($data['invoiceAmount']) }}</h2>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                                <a href="{{ route('bills.index') }}" class="text-decoration-none">
                                    <div class="bg-success shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                        ...
                                        <div class="text-end text-white">
                                            <h2 class="fs-1-xxl fw-bolder text-white">{{$currencySymbol}} {{ formatCurrency($data['billAmount']) }}</h2>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                                <a href="{{ route('payments.index') }}" class="text-decoration-none">
                                    <div class="bg-info shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                        ...
                                        <div class="text-end text-white">
                                            <h2 class="fs-1-xxl fw-bolder text-white">{{$currencySymbol}} {{ formatCurrency($data['paymentAmount']) }}</h2>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                                <a href="{{ route('advanced-payments.index') }}" class="text-decoration-none">
                                    <div class="bg-warning shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                        ...
                                        <div class="text-end text-white">
                                            <h2 class="fs-1-xxl fw-bolder text-white">{{$currencySymbol}} {{ formatCurrency($data['advancePaymentAmount']) }}</h2>
                            ...
                            @if($modules['Nurses'] == true)
                                ...
                                <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                                    <a href="{{ route('nurses.index') }}" class="text-decoration-none">
                                        <div class="bg-secondary shadow-md rounded-10 p-xxl-10 px-7 py-10 d-flex align-items-center justify-content-between my-3">
                                            <div class="bg-gray-700 widget-icon rounded-10 d-flex align-items-center justify-content-center">
