...
<div class="row mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mobile-overlapping  mb-5">
            ...
            {{ Form::tel('phone', null, ['class' => 'form-control phoneNumber', 'required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'tabindex' => '5']) }}
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select', 'id' => 'bloodGroupPatient', 'placeholder' => 'Select Blood Group', 'data-control' => 'select2', 'tabindex' => "9"]) }}
        </div>
    </div>
