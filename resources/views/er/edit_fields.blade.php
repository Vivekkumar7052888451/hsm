    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::select('case_id', [null], null, ['class' => 'form-select editIpdDepartmentCaseId', 'required', 'id' => 'editIpdDepartmentCaseId', 'disabled', 'data-control' => 'select2', 'placeholder' => 'Choose Case']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
           <div class="mb-5">
                ...
                {{ Form::text('er_number', null, ['class' => 'form-control', 'readonly']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::select('bed_id', [null], null, ['class' => 'form-select', 'required', 'id' => 'editIpdBedId', 'disabled', 'data-control' => 'select2', 'placeholder' => 'Bed Id']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
            ...
            <div class="mb-5">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" name="is_old_patient" type="checkbox" value="1"
                           id="flexSwitchDefault" {{ ($erRoom->is_old_patient) ? 'checked' : '' }}>
                </div>
            </div>
        </div>
    </div>
