    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::select('case_id', [null], null, ['class' => 'form-select ipdDepartmentCaseId', 'required', 'id' => 'ipdDepartmentCaseId', 'data-control' => 'select2', 'placeholder' => __('messages.ipd_patient.choose_case')]) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                {{ Form::label('er_number', __('messages.emergency.er_number').':', ['class' => 'form-label']) }}
                {{ Form::text('er_number', $data['erNumber'], ['class' => 'form-control', 'readonly']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::text('admission_date', null, ['class' => (getLoggedInUser()->theme_mode) ? 'form-control bg-light ipdAdmissionDate' : 'form-control bg-white ipdAdmissionDate','id' => 'ipdAdmissionDate','autocomplete' => 'off', 'required', 'tabindex' => '5']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::select('bed_id', [null], null, ['class' => 'form-select', 'required', 'id' => 'ipdBedId', 'data-control' => 'select2', 'placeholder' => 'Choose Bed']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
