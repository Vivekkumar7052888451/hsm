<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('charge_category_id',$data['chargeCategories'], null, ['class' => 'form-select charge-category','required','id' => 'editChargeCategory','placeholder'=>'Select Charge Category','required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            {{ Form::text('standard_charge', null, ['class' => 'form-control price-input rd-test-standard-charge', 'id' => 'editRdTestStandardCharge', 'readonly', 'required']) }}
        </div>
    </div>
